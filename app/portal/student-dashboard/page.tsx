...
import {
  ...
  MoreHorizontal, IdCard, User, Mail, MapPin, 
  RefreshCcw, Shield, Fingerprint, Copy, Check
} from "lucide-react";
...
export default function StudentDashboardPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#02040a", color: "#fff", display: "flex", flexDirection: "column", paddingBottom: "120px" }}>
      ...
      <header style={{ padding: "60px 24px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <button onClick={() => router.back()} style={{ width: "48px", height: "48px", borderRadius: "16px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <ArrowLeft size={22} />
        </button>
        ...
        <button onClick={handleSync} style={{ width: "48px", height: "48px", borderRadius: "16px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <main style={{ padding: "0 24px", flex: 1 }}>
        {!profile.name ? (
          <div style={{ height: "50vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
            ...
            <p style={{ marginTop: "20px", color: "#00d4ff", fontSize: "10px", fontWeight: 700, letterSpacing: "0.2em" }}>SYNCING IDENTITY...</p>
          </div>
        ) : (
          <div>
            <div className="nexus-card" style={{ textAlign: "center", marginBottom: "24px" }}>
              <div style={{ width: "100px", height: "100px", borderRadius: "30px", background: "linear-gradient(135deg, rgba(0,212,255,0.15), rgba(0,212,255,0.05))", margin: "0 auto 20px", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(0,212,255,0.2)" }}>
